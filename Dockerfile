...
RUN openssl pkcs12 -export -in /data/client.cer -inkey /data/scb-apibanking-client-cert-private-key.pem -out /data/scb-apibanking.keystore.p12 -name pharmacity -password pass:hkcG2xZcheLTs1v9
